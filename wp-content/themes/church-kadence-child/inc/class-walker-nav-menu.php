...
class Church_Walker_Nav_Menu extends Walker_Nav_Menu {
    ...
    function start_el(&$output, $item, $depth = 0, $args = null, $id = 0) {
        ...
        // Стрелочка для выпадающего меню (только на десктопе)
        if (in_array('menu-item-has-children', $classes)) {
            $item_output .= '<span class="dropdown-toggle" aria-expanded="false" aria-label="Открыть подменю">
                <svg class="icon-chevron" width="10" height="6" viewBox="0 0 10 6" fill="none">
